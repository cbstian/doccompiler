...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'pulse' => [
            'driver' => env('PULSE_DB_DRIVER', env('DB_CONNECTION', 'mysql')),
            ...
            'charset' => env('PULSE_DB_CHARSET', env('DB_CHARSET', 'utf8mb4')),
            'collation' => env('PULSE_DB_COLLATION', env('DB_COLLATION', 'utf8mb4_unicode_ci')),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                Mysql::ATTR_SSL_CA => env('PULSE_MYSQL_ATTR_SSL_CA', env('MYSQL_ATTR_SSL_CA')),
            ]) : [],
        ],
