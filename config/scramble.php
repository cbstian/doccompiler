...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API REST M2M para convertir documentos en texto utilizable por sistemas de IA. Los endpoints versionados requieren autenticación mediante `Authorization: Bearer <token>`. El endpoint de salud es público.',
    ],

    'ui' => [
        'title' => 'DocCompiler API',
    ],
